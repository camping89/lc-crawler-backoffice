...
public class ParserArticleLongChauBackgroundWorker : HangfireBackgroundWorkerBase
{
    ...
    public ParserArticleLongChauBackgroundWorker(MediaManagerLongChau mediaManager, IArticleRepository articleRepository, IDataSourceRepository dataSourceRepository, ArticleManager articleManager)
    {
