...
public class SyncArticleSucKhoeGiaDinhBackgroundWorker : HangfireBackgroundWorkerBase
{
    ...
    public SyncArticleSucKhoeGiaDinhBackgroundWorker(IArticleSucKhoeGiaDinhRepository articleSucKhoeGiaDinhRepository, IMediaSucKhoeGiaDinhRepository mediaSucKhoeGiaDinhRepository, MediaManagerSucKhoeGiaDinh mediaManagerSucKhoeGiaDinh, IDataSourceRepository dataSourceRepository, ICategorySucKhoeGiaDinhRepository categorySucKhoeGiaDinhRepository)
    {
