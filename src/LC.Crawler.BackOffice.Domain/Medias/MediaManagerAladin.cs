...
{
    public class MediaManagerAladin : DomainService
    {
        private readonly IMediaAladinRepository _mediaRepository;
        private readonly IBlobContainer _blobContainer;

        public MediaManagerAladin(IMediaAladinRepository mediaRepository, IBlobContainer blobContainer)
        {
