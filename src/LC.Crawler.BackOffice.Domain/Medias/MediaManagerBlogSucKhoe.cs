...
public class MediaManagerBlogSucKhoe : DomainService
{
    private readonly IMediaBlogSucKhoeRepository _mediaRepository;
    private readonly IBlobContainer _blobContainer;

    public MediaManagerBlogSucKhoe(IMediaBlogSucKhoeRepository mediaRepository, IBlobContainer blobContainer)
    {
    ...
    private async Task SaveMedia(Media media)
    {
        ...
        if (fileBytes != null)
        {
            var fileName = $"{Enum.GetName(PageDataSource.BlogSucKhoe)}{media.Id}{fileExtension}";
