...
public class MediaManagerSieuThiSongKhoe : DomainService
{
    private readonly IMediaSieuThiSongKhoeRepository _mediaRepository;
    private readonly IBlobContainer _blobContainer;

    public MediaManagerSieuThiSongKhoe(IMediaSieuThiSongKhoeRepository mediaRepository, IBlobContainer blobContainer)
    {
