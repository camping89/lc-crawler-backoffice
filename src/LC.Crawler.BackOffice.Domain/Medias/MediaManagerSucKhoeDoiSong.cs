...
public class MediaManagerSucKhoeDoiSong : DomainService
{
    private readonly IMediaSucKhoeDoiSongRepository _mediaRepository;
    private readonly IBlobContainer _blobContainer;

    public MediaManagerSucKhoeDoiSong(IMediaSucKhoeDoiSongRepository mediaRepository, IBlobContainer blobContainer)
    {
    ...
    private async Task SaveMedia(Media media)
    {
        ...
        if (fileBytes != null)
        {
            var fileName = $"{Enum.GetName(PageDataSource.SucKhoeDoiSong)}{media.Id}{fileExtension}";
