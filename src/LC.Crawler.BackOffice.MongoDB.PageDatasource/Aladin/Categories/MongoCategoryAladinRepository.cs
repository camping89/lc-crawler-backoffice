...
namespace LC.Crawler.BackOffice.PageDatasource.Aladin.Categories
{
    public class MongoCategoryAladinRepository : MongoDbRepository<AladinMongoDbContext, Category, Guid>, ICategoryAladinRepository
    {
        public MongoCategoryAladinRepository(IMongoDbContextProvider<AladinMongoDbContext> dbContextProvider)
