...
namespace LC.Crawler.BackOffice.PageDatasource.Aladin.Medias
{
    public class MongoMediaAladinRepository : MongoDbRepository<AladinMongoDbContext, Media, Guid>, IMediaAladinRepository
    {
        public MongoMediaAladinRepository(IMongoDbContextProvider<AladinMongoDbContext> dbContextProvider)
