...
namespace LC.Crawler.BackOffice.PageDatasource.AloBacSi.Categories
{
    public class MongoCategoryAloBacSiRepository : MongoDbRepository<AloBacSiMongoDbContext, Category, Guid>, ICategoryAloBacSiRepository
    {
        public MongoCategoryAloBacSiRepository(IMongoDbContextProvider<AloBacSiMongoDbContext> dbContextProvider)
