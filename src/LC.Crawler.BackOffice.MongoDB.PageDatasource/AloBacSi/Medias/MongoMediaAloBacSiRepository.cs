...
namespace LC.Crawler.BackOffice.PageDatasource.AloBacSi.Medias
{
    public class MongoMediaAloBacSiRepository : MongoDbRepository<AloBacSiMongoDbContext, Media, Guid>, IMediaAloBacSiRepository
    {
        public MongoMediaAloBacSiRepository(IMongoDbContextProvider<AloBacSiMongoDbContext> dbContextProvider)
