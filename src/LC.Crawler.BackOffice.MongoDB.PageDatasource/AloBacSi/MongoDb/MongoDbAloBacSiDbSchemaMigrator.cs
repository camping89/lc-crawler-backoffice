...
public class MongoDbAloBacSiDbSchemaMigrator : IBackOfficeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAloBacSiDbSchemaMigrator(IServiceProvider serviceProvider)
    {
