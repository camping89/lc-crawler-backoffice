...
namespace LC.Crawler.BackOffice.PageDatasource.BlogSucKhoe.Articles
{
    public class MongoArticleBlogSucKhoeRepository : MongoDbRepository<BlogSucKhoeMongoDbContext, Article, Guid>, IArticleBlogSucKhoeRepository
    {
        public MongoArticleBlogSucKhoeRepository(IMongoDbContextProvider<BlogSucKhoeMongoDbContext> dbContextProvider)
