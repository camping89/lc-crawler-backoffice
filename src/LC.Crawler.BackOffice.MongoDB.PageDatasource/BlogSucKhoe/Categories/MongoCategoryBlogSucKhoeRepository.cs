...
namespace LC.Crawler.BackOffice.PageDatasource.BlogSucKhoe.Categories
{
    public class MongoCategoryBlogSucKhoeRepository : MongoDbRepository<BlogSucKhoeMongoDbContext, Category, Guid>, ICategoryBlogSucKhoeRepository
    {
        public MongoCategoryBlogSucKhoeRepository(IMongoDbContextProvider<BlogSucKhoeMongoDbContext> dbContextProvider)
