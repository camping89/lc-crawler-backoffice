...
namespace LC.Crawler.BackOffice.PageDatasource.BlogSucKhoe.Medias
{
    public class MongoMediaBlogSucKhoeRepository : MongoDbRepository<BlogSucKhoeMongoDbContext, Media, Guid>, IMediaBlogSucKhoeRepository
    {
        public MongoMediaBlogSucKhoeRepository(IMongoDbContextProvider<BlogSucKhoeMongoDbContext> dbContextProvider)
