...
namespace LC.Crawler.BackOffice.PageDatasource.LongChau.Articles
{
    public class MongoArticleLongChauRepository : MongoDbRepository<LongChauMongoDbContext, Article, Guid>, IArticleLongChauRepository
    {
        public MongoArticleLongChauRepository(IMongoDbContextProvider<LongChauMongoDbContext> dbContextProvider)
