...
public class MongoDbLongChauDbSchemaMigrator : IBackOfficeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbLongChauDbSchemaMigrator(IServiceProvider serviceProvider)
    {
