...
namespace LC.Crawler.BackOffice.PageDatasource.LongChau.Products
{
    public class MongoProductLongChauRepository : MongoDbRepository<LongChauMongoDbContext, Product, Guid>, IProductLongChauRepository
    {
        public MongoProductLongChauRepository(IMongoDbContextProvider<LongChauMongoDbContext> dbContextProvider)
