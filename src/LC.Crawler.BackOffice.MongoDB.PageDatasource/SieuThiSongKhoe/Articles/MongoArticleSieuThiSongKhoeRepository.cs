...
namespace LC.Crawler.BackOffice.PageDatasource.SieuThiSongKhoe.Articles;

public class MongoArticleSieuThiSongKhoeRepository : MongoDbRepository<SieuThiSongKhoeMongoDbContext, Article, Guid>, IArticleSieuThiSongKhoeRepository
{
    public MongoArticleSieuThiSongKhoeRepository(IMongoDbContextProvider<SieuThiSongKhoeMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
