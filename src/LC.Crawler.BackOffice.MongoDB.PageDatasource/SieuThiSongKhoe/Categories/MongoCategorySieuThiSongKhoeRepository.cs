...
namespace LC.Crawler.BackOffice.PageDatasource.SieuThiSongKhoe.Categories;

public class MongoCategorySieuThiSongKhoeRepository : MongoDbRepository<SieuThiSongKhoeMongoDbContext, Category, Guid>, ICategorySieuThiSongKhoeRepository
{
    public MongoCategorySieuThiSongKhoeRepository(IMongoDbContextProvider<SieuThiSongKhoeMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
