...
namespace LC.Crawler.BackOffice.PageDatasource.SieuThiSongKhoe.Products;

public class MongoProductSieuThiSongKhoeRepository : MongoDbRepository<SieuThiSongKhoeMongoDbContext, Product, Guid>, IProductSieuThiSongKhoeRepository
{
    public MongoProductSieuThiSongKhoeRepository(IMongoDbContextProvider<SieuThiSongKhoeMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
