...
namespace LC.Crawler.BackOffice.PageDatasource.SongKhoeMedplus.Medias;

public class MongoMediaSongKhoeMedplusRepository : MongoDbRepository<SongKhoeMedplusMongoDbContext, Media, Guid>,
    IMediaSongKhoeMedplusRepository
{
    public MongoMediaSongKhoeMedplusRepository(IMongoDbContextProvider<SongKhoeMedplusMongoDbContext> dbContextProvider)
        ...
        bool? isDowloaded = null)
    {
        return query
            .WhereIf(!string.IsNullOrWhiteSpace(filterText),
                e => e.Name.Contains(filterText) || e.ContentType.Contains(filterText) || e.Url.Contains(filterText) ||
