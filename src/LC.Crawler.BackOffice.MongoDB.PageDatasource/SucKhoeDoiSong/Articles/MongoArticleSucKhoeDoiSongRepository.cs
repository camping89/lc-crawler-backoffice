...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeDoiSong.Articles
{
    public class MongoArticleSucKhoeDoiSongRepository : MongoDbRepository<SucKhoeDoiSongMongoDbContext, Article, Guid>, IArticleSucKhoeDoiSongRepository
    {
        public MongoArticleSucKhoeDoiSongRepository(IMongoDbContextProvider<SucKhoeDoiSongMongoDbContext> dbContextProvider)
