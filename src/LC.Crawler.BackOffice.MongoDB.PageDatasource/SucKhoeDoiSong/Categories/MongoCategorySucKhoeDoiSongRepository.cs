...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeDoiSong.Categories
{
    public class MongoCategorySucKhoeDoiSongRepository : MongoDbRepository<SucKhoeDoiSongMongoDbContext, Category, Guid>, ICategorySucKhoeDoiSongRepository
    {
        public MongoCategorySucKhoeDoiSongRepository(IMongoDbContextProvider<SucKhoeDoiSongMongoDbContext> dbContextProvider)
