...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeDoiSong.Medias
{
    public class MongoMediaSucKhoeDoiSongRepository : MongoDbRepository<SucKhoeDoiSongMongoDbContext, Media, Guid>, IMediaSucKhoeDoiSongRepository
    {
        public MongoMediaSucKhoeDoiSongRepository(IMongoDbContextProvider<SucKhoeDoiSongMongoDbContext> dbContextProvider)
