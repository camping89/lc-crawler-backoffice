...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeDoiSong.MongoDb;

public class MongoDbSucKhoeDoiSongDbSchemaMigrator : IBackOfficeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSucKhoeDoiSongDbSchemaMigrator(IServiceProvider serviceProvider)
    {
