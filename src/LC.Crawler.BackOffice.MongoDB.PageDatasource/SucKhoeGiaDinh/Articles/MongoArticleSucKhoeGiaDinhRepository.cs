...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeGiaDinh.Articles
{
    public class MongoArticleSucKhoeGiaDinhRepository : MongoDbRepository<SucKhoeGiaDinhMongoDbContext, Article, Guid>, IArticleSucKhoeGiaDinhRepository
    {
        public MongoArticleSucKhoeGiaDinhRepository(IMongoDbContextProvider<SucKhoeGiaDinhMongoDbContext> dbContextProvider)
