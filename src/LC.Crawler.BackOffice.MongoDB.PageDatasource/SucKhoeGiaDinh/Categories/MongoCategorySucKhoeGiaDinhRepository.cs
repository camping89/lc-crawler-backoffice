...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeGiaDinh.Categories
{
    public class MongoCategorySucKhoeGiaDinhRepository : MongoDbRepository<SucKhoeGiaDinhMongoDbContext, Category, Guid>, ICategorySucKhoeGiaDinhRepository
    {
        public MongoCategorySucKhoeGiaDinhRepository(IMongoDbContextProvider<SucKhoeGiaDinhMongoDbContext> dbContextProvider)
