...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeGiaDinh.Medias
{
    public class MongoMediaSucKhoeGiaDinhRepository : MongoDbRepository<SucKhoeGiaDinhMongoDbContext, Media, Guid>, IMediaSucKhoeGiaDinhRepository
    {
        public MongoMediaSucKhoeGiaDinhRepository(IMongoDbContextProvider<SucKhoeGiaDinhMongoDbContext> dbContextProvider)
