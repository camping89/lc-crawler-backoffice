...
namespace LC.Crawler.BackOffice.PageDatasource.SucKhoeGiaDinh.MongoDb;

public class MongoDbSucKhoeGiaDinhDbSchemaMigrator : IBackOfficeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSucKhoeGiaDinhDbSchemaMigrator(IServiceProvider serviceProvider)
    {
