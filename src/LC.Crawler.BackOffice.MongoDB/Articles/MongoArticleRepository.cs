...
{
    public class MongoArticleRepository : MongoDbRepository<BackOfficeMongoDbContext, Article, Guid>, IArticleRepository
    {
        public MongoArticleRepository(IMongoDbContextProvider<BackOfficeMongoDbContext> dbContextProvider)
