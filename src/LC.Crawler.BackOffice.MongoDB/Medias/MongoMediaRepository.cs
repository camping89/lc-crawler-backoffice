...
{
    public class MongoMediaRepository : MongoDbRepository<BackOfficeMongoDbContext, Media, Guid>, IMediaRepository
    {
        public MongoMediaRepository(IMongoDbContextProvider<BackOfficeMongoDbContext> dbContextProvider)
