...
public class MongoDbBackOfficeDbSchemaMigrator : IBackOfficeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbBackOfficeDbSchemaMigrator(IServiceProvider serviceProvider)
    {
